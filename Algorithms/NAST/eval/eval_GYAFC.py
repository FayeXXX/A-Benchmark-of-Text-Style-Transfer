...
def eval_main(args):
	...
	import run_cls
	cls_param = Storage()
	cls_param.args = run_cls.run("--dryrun", "--restore", args.clsrestore, "--cuda", "--dataid", args.dataid,"--roberta", "/home/xyf/LanguageModel/roberta-base")
	...
	import run_lm
	lm_param = Storage()
	lm_param.args = run_lm.run("--dryrun", "--restore", args.lmrestore, "--dataid", args.dataid,"--gpt","/home/xyf/LanguageModel/gpt2")
