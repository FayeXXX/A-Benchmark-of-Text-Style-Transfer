def run(*argv):
	...
	args.min_freq = 3
	args.max_length = cargs.max_length
	args.embed_size = 256
	args.d_model = 256
	args.h = 4
	args.num_styles = 2
	...
	args.name = f'self:{cargs.self_factor}_cyclic:{cargs.cyc_factor}_advf:{cargs.fw_adv_factor}_advb:{cargs.bw_adv_factor}_{cargs.name}'
