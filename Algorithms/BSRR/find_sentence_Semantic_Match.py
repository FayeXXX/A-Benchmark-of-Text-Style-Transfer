...
tokenizer = AutoTokenizer.from_pretrained("/home/xyf/LanguageModel/princeton-nlp/sup-simcse-roberta-base")
model = AutoModel.from_pretrained("/home/xyf/LanguageModel/princeton-nlp/sup-simcse-roberta-base")
...
style_classifier = StyleClassifier('amazon').cuda().eval()
