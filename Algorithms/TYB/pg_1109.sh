...
#python train.py -style 0 -ratio 1.0 -dataset $1 -order $2 -sc_factor $3 -bl_factor $4 -$5 -$6
#python infer.py -style 0 -dataset $1 -order $2 -sc_factor $3 -bl_factor $4
#rm checkpoints/bart_$1_$2_0.chkpt

python train.py -style 1 -ratio 1.0 -dataset $1 -order $2 -sc_factor $3 -bl_factor $4 -$5 -$6
