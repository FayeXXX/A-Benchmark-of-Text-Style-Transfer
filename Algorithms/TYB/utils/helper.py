...
def cal_sc_loss(out, idx, cls, tokenizer, style, sc_factor):
    ...
    loss_sc = cal_reward_loss(sample_probs, tgt_reward*sc_factor, idx)

    return loss_sc


def cal_bl_loss(out, tgt, idx, tokenizer, bl_factor):
    ...
    loss_co = cal_reward_loss(sample_probs, (tgt_gre-tgt_sam)*bl_factor, idx)
