...
elasticsearch = Elasticsearch(hosts="https://127.0.0.1:9200")
# elasticsearch = Elasticsearch([{'host':'localhost','port':9200,'scheme':'http'}])
class SparseRetriever(nn.Module):
    ...
    def __init__(self, unpaired_sents, vocab, es_server, es_index, add_sos=True, add_eos=True):
        ...
        elasticsearch = Elasticsearch(hosts=es_server)
