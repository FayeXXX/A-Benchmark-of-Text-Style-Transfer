...
def load_human_answer(data_path, dataset):
    ans = []
    file_list = [
    ...
    if dataset == 'gyafcfr' or dataset == 'gyafcem':
        file_list = [
            data_path + 'reference.1',
            data_path + 'reference.0',
        ]
...
def prepare_data(data_path, max_num, task_type):
    ...
    train_file_list = []
    train_label_list = []
    if task_type == 'yelp' or task_type == 'amazon' or task_type == 'imdb':
        train_file_list = [
    ...
    if task_type == 'gyafcem' or task_type == 'gyafcfr' or task_type == 'shakespeare':
        train_file_list = [
